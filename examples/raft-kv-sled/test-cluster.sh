...
bin=./target/debug/raft-key-value-sled

echo "Killing all running raft-key-value-sled and cleaning up old data"
...
echo "Start 3 uninitialized raft-key-value-sled servers..."
