...
pub struct ExampleSnapshot {
    pub meta: SnapshotMeta<ExampleNodeType>,
...
pub struct SerializableExampleStateMachine {
    ...
    pub last_membership: EffectiveMembership<ExampleNodeType>,
...
fn sm_r_err<E: Error + 'static>(e: E) -> StorageError<ExampleNodeType> {
    StorageIOError::new(ErrorSubject::StateMachine, ErrorVerb::Read, AnyError::new(&e)).into()
}
fn sm_w_err<E: Error + 'static>(e: E) -> StorageError<ExampleNodeType> {
    StorageIOError::new(ErrorSubject::StateMachine, ErrorVerb::Write, AnyError::new(&e)).into()
}

impl ExampleStateMachine {
    fn get_last_membership(&self) -> StorageResult<EffectiveMembership<ExampleNodeType>> {
        self.db
            .get_cf(
    ...
    fn set_last_membership(&self, membership: EffectiveMembership<ExampleNodeType>) -> StorageResult<()> {
        self.db
            .put_cf(
                self.db.cf_handle("state_machine").expect("cf_handle"),
                "last_membership".as_bytes(),
...
type StorageResult<T> = Result<T, StorageError<ExampleNodeType>>;
...
impl RaftSnapshotBuilder<ExampleTypeConfig, Cursor<Vec<u8>>> for Arc<ExampleStore> {
    ...
    async fn build_snapshot(
        &mut self,
    ) -> Result<Snapshot<ExampleNodeType, Cursor<Vec<u8>>>, StorageError<ExampleNodeType>> {
        let data;
...
impl RaftStorage<ExampleTypeConfig> for Arc<ExampleStore> {
    ...
    #[tracing::instrument(level = "trace", skip(self))]
    async fn save_vote(&mut self, vote: &Vote<ExampleNodeId>) -> Result<(), StorageError<ExampleNodeType>> {
        self.set_vote_(vote)
    }

    async fn read_vote(&mut self) -> Result<Option<Vote<ExampleNodeId>>, StorageError<ExampleNodeType>> {
        self.get_vote_()
    }
    ...
    #[tracing::instrument(level = "debug", skip(self))]
    async fn purge_logs_upto(&mut self, log_id: LogId<ExampleNodeId>) -> Result<(), StorageError<ExampleNodeType>> {
    ...
    async fn last_applied_state(
        &mut self,
    ) -> Result<(Option<LogId<ExampleNodeId>>, EffectiveMembership<ExampleNodeType>), StorageError<ExampleNodeType>>
    {
    ...
    ) -> Result<Vec<ExampleResponse>, StorageError<ExampleNodeType>> {
    ...
    #[tracing::instrument(level = "trace", skip(self))]
    async fn begin_receiving_snapshot(&mut self) -> Result<Box<Self::SnapshotData>, StorageError<ExampleNodeType>> {
    ...
    async fn install_snapshot(
        &mut self,
        meta: &SnapshotMeta<ExampleNodeType>,
        snapshot: Box<Self::SnapshotData>,
    ) -> Result<StateMachineChanges<ExampleTypeConfig>, StorageError<ExampleNodeType>> {
        tracing::info!(
    ...
    async fn get_current_snapshot(
        &mut self,
    ) -> Result<Option<Snapshot<ExampleNodeType, Self::SnapshotData>>, StorageError<ExampleNodeType>> {
