    ...
    Self: Wrapper<C, T>,
{
    ...
    async fn defensive_no_dirty_log(&mut self) -> Result<(), StorageError<C::NodeId, C::NodeData>> {
        if !self.is_defensive() {
            return Ok(());
        }
    ...
    async fn defensive_consecutive_input(
        &self,
        entries: &[&Entry<C>],
    ) -> Result<(), StorageError<C::NodeId, C::NodeData>> {
        if !self.is_defensive() {
    ...
    async fn defensive_nonempty_input(
        &self,
        entries: &[&Entry<C>],
    ) -> Result<(), StorageError<C::NodeId, C::NodeData>> {
        if !self.is_defensive() {
    ...
    async fn defensive_apply_log_id_gt_last(
        &mut self,
        entries: &[&Entry<C>],
    ) -> Result<(), StorageError<C::NodeId, C::NodeData>> {
        if !self.is_defensive() {
