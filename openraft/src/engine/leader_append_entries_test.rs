...
fn m1_2() -> Membership<TestNodeType> {
    Membership::<TestNodeType>::new(vec![btreeset! {1}], Some(btreeset! {2}))
}

fn m13() -> Membership<TestNodeType> {
    Membership::<TestNodeType>::new(vec![btreeset! {1,3}], None)
}
